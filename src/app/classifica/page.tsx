			...
			<div className="container mx-auto px-4 py-8">
				<div className="mb-8">
					...
					<p className={styles.textMuted}>
						Scopri chi sono i migliori partecipanti alle competizioni!
					</p>
				</div>
				...
				<div
					...
					<div className="flex flex-col md:flex-row md:justify-between md:items-center gap-4">
						<div>
							<h3 className={`text-sm font-medium ${styles.textColor} mb-2`}>
								Filtra per team
							</h3>
					...
					<div className="overflow-x-auto">
                        ...
                        `}>
										...
										<td className="px-6 py-4 whitespace-nowrap">
											<div className="flex items-center">
												<div
													className={`h-4 w-4 rounded-full mr-2 ${getTeamColor(user.team)}`}></div>
				...
				<div className="grid grid-cols-1 md:grid-cols-3 gap-6 mt-8">
					<div
						...
						<h3 className={`text-lg font-medium mb-4 ${styles.textColor}`}>
							Punteggio per Team
						</h3>
					...
					<div
						...
						<div className="space-y-3">
							{leaderboard
								.sort(
									(a, b) =>
										(b.skills['Coding'] || 0) - (a.skills['Coding'] || 0),
								)
								.slice(0, 5)
								.map((user) => (
										...
										<div className="flex-1">
											...
											<div className="h-1.5 w-full bg-slate-700 rounded-full overflow-hidden mt-1">
												<div
													...
													style={{ width: `${user.skills['Coding']}%` }}></div>
											</div>
										</div>
									</div>
								))}
					...
					<div
						...
						<div className="space-y-3">
							{leaderboard
								.sort(
									(a, b) =>
										(b.skills['Security'] || 0) - (a.skills['Security'] || 0),
								)
								.slice(0, 5)
								.map((user) => (
									<div key={user.id} className="flex items-center">
