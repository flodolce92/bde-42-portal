...
const exampleEvents: Event[] = [
	...
	},
	{
		...
		description:
			'Un workshop pratico di mezza giornata su React: componenti, hooks e best practice. Materiali e esercizi inclusi.',
		date: '2024-07-10',
		time: '09:30',
		duration: '4h',
		type: 'workshop',
		...
		files: [
			{
				name: 'Slides - Introduzione a React.pdf',
				url: 'https://example.com/files/react-workshop-slides.pdf',
			},
			{
				name: 'Esercizi.zip',
				url: 'https://example.com/files/react-workshop-exercises.zip',
			},
		],
		participants: ['1', '2'],
	},
...
export const useAppStore = create<AppState>()(
	persist(
		(set) => ({
			...
			updateScore: (userId, additionalScore) =>
				set((state) => {
			...
			updateSkill: (userId, skillName, level) =>
				set((state) => {
