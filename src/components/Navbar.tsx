			...
			return (
				<div className="absolute left-0 right-0 bottom-0 h-1 overflow-hidden">
					<div
						...
						style={{
							background:
								'linear-gradient(90deg, transparent, var(--wave-2), transparent)',
							width: '200%',
			...
			return (
				<div className="absolute left-0 right-0 bottom-0 h-2 overflow-hidden">
					<div
						...
						style={{
							background:
								'linear-gradient(45deg, var(--flame-3) 0%, var(--flame-2) 25%, var(--flame-1) 50%, var(--flame-2) 75%, var(--flame-3) 100%)',
							clipPath:
						...
						<div className="flex">
							<div className="flex-shrink-0 flex items-center">
								<Link href="/" className="font-bold text-3xl">
									<span className="font-black">42</span> BDE Portale
								</Link>
							</div>
							<div className="hidden sm:ml-10 lg:flex sm:space-x-6 items-center">
								<Link
									href="/dashboard"
							...
							<div className="hidden items-center lg:flex">
								<div className="flex space-x-2">
									<button
										...
										title="Team Acqua">
										<span
											className="absolute inset-0 rounded-full bg-gradient-to-br from-sky-400 to-sky-600 animate-pulse-slow"
											style={{
									...
									<button
										...
										title="Team Fuoco">
										<span
											className="absolute inset-0 rounded-full bg-gradient-to-br from-red-400 to-red-600 animate-pulse-slow"
											style={{
									...
									<button
										...
										title="Team Erba">
										<span
											className="absolute inset-0 rounded-full bg-gradient-to-br from-green-400 to-green-600 animate-pulse-slow"
											style={{
